...
async function loadKit(rootDir) {
	try {
		...
		if (e.toString().includes("Cannot find module '@nuxt/kit'")) throw new Error("`@nuxt/test-utils` requires `@nuxt/kit` to be installed in your project. Try installing `nuxt` v3+ or `@nuxt/bridge` first.", { cause: e });
		throw e;
	}
}
...
//#endregion
export { deepCopy as n, loadKit as r, applyEnv as t };
