import { A as caseInsensitive, C as whitespace, D as Join, E as wordChar, F as unicode, I as withIndices, M as global, N as multiline, O as UnionToTuple, P as sticky, S as tab, T as wordBoundary, _ as letter, a as InputSource, b as not, c as MapToGroups, d as carriageReturn, f as char, g as exactly, h as digit, i as StringCapturedBy, j as dotAll, k as Flag, l as Input$1, m as charNotIn, n as MagicRegExpMatchArray, o as JoinValues, p as charIn, r as MapToStringCapturedBy, u as anyOf, v as linefeed, w as word, x as oneOrMore, y as maybe } from "./magic-regexp-KJeJieb-.mjs";
...
export type MagicRegExp<Value extends string, NamedGroups extends string | never = never, Flags extends Flag[] | never = never> = RegExp & {
...
//#endregion
export { Flag, type Input$1 as Input, MagicRegExpMatchArray, MapToStringCapturedBy, StringCapturedBy, anyOf, carriageReturn, caseInsensitive, char, charIn, charNotIn, digit, dotAll, exactly, global, letter, linefeed, maybe, multiline, not, oneOrMore, spreadRegExpIterator, spreadRegExpMatchArray, sticky, tab, unicode, whitespace, withIndices, word, wordBoundary, wordChar };