...
var script = {
  ...
  beforeUnmount: function beforeUnmount() {
    ...
    // Remove the field from the form when the FormField leaves the DOM (e.g. an array item is
    // deleted), so its value/validation state no longer persists in the form data.
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return !_ctx.asChild ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.as), mergeProps({
    ...
    "class": _ctx.cx('root'),
    props: $options.field.props
  }, $options.fieldAttrs), undefined, undefined, 1);
}
