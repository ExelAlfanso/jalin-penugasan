 ...
 *
 * [Live Demo](https://www.primevue.dev/forms/)
 *
 * @module form
 *
 */
 ...
 */
export interface FormResolverOptions<T extends Record<string, any> = Record<string, any>> {
    /**
...
export interface FormProps<T extends Record<string, any> = Record<string, any>> {
     ...
     */
    resolver?: (e: FormResolverOptions<T>) => Promise<Record<string, any>> | Record<string, any> | undefined;
    /**
...
export interface FormSlots {
    ...
    default: (
        scope: {
            ...
            /**
             * Removes a previously registered form field, dropping its value and validation state.
             * @param field - The name of the form field to remove.
             */
            ...
            /**
             * Sets the values of multiple form fields at once.
             * @param values - An object mapping field names to their new values.
             */
            setValues: (values: Record<string, any>) => void;
            /**
             * Validates the form, or a specific field / list of fields when a name is provided.
             * @param field - Optional field name (or names) to validate; validates the whole form when omitted.
             * @returns - A promise resolving to the validation result.
             */
            validate: (field?: string | string[]) => Promise<Record<string, any>>;
            /**
...
export interface FormInstance<T extends Record<string, any> = Record<string, any>> {
     ...
     * Registers a form field for validation and tracking.
     * @param field field name
     * @param options field options (validation rules, etc.)
     * @returns the field's bindable props
     */
    register: (field: string, options?: any) => any;
    /**
     * Removes a previously registered field, dropping its value and validation state from the form.
     * Useful when a field is removed from the UI (e.g. deleting an item from an array of objects).
     * @param field field name
     */
    unregister: (field: string) => void;
    /**
     * Defines a form field and returns its state and bindable props.
     * @param field field name
     * @param options field options
     * @returns a tuple of the field state and its bindable props
     */
    defineField: (field: string, options?: any) => any[];
    /**
     * The registered fields of the form, keyed by field name.
     */
 ...
 *
 */
declare const Form: DefineComponent<FormProps, FormSlots, FormEmits, FormInstance>;

declare module 'vue' {
    export interface GlobalComponents {
        Form: DefineComponent<FormProps, FormSlots, FormEmits, FormInstance>;
    }
}
